...
var MyAttendances = AbstractAction.extend({
    ...
    events: {
        ...
        "click .o_hr_attendance_break_in_out_icon": _.debounce(function() {
            this.update_break_attendance();
        }, 200, true),
    },
    ...
    willStart: function () {
        ...
        var def = this._rpc({
                model: 'hr.employee',
                method: 'search_read',
                args: [[['user_id', '=', this.getSession().uid]], ['attendance_state','attendance_break_state', 'name', 'hours_today']],
    ...
    update_break_attendance: function () {
        var self = this;
        this._rpc({
                model: 'hr.employee',
